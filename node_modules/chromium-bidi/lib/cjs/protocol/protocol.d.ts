...
export type BiDiCommand = BrowsingContext.Command | CDP.Command | Script.Command | Session.Command;
export declare namespace Message {
    ...
    type CommandRequest = Pick<RawCommandRequest, 'id'> & BiDiCommand;
    type CommandResponse = Pick<RawCommandRequest, 'id'> & ResultData;
    type EmptyParams = Record<string, never>;
    type EmptyResult = {
        result: Record<string, never>;
    };
    type ResultData = EmptyResult | BrowsingContext.Result | CDP.Result | ErrorResult | Script.Result | Session.Result;
...
export declare namespace Session {
    ...
    type Result = StatusResult | SubscribeResult | UnsubscribeResult;
    type StatusCommand = {
    ...
    type SubscribeResult = Message.EmptyResult;
    type UnsubscribeCommand = {
        method: 'session.unsubscribe';
        params: SubscriptionRequest;
    };
    type UnsubscribeResult = Message.EmptyResult;
}
