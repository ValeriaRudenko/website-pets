...
export class Frame extends BaseFrame {
    constructor(page, context, parentId) {
        ...
        this._parentId = parentId !== null && parentId !== void 0 ? parentId : undefined;
    }
    page() {
    ...
    parentFrame() {
        var _a;
        return __classPrivateFieldGet(this, _Frame_page, "f").frame((_a = this._parentId) !== null && _a !== void 0 ? _a : '');
    }
    childFrames() {
