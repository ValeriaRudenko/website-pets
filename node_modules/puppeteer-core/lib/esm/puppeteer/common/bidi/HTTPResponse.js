...
export class HTTPResponse extends BaseHTTPResponse {
    constructor(request, responseEvent) {
        ...
        __classPrivateFieldSet(this, _HTTPResponse_timings, (_a = response.timings) !== null && _a !== void 0 ? _a : null, "f");
        ...
        for (const header of response.headers || []) {
            __classPrivateFieldGet(this, _HTTPResponse_headers, "f")[header.name] = (_b = header.value) !== null && _b !== void 0 ? _b : '';
        }
    }
    remoteAddress() {
