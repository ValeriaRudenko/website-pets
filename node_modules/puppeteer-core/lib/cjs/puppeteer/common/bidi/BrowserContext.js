...
class BrowserContext extends BrowserContext_js_1.BrowserContext {
    ...
    async newPage() {
        ...
        const page = new Page_js_1.Page(__classPrivateFieldGet(this, _BrowserContext_connection, "f"), result);
    ...
    async close() {
        for (const page of __classPrivateFieldGet(this, _BrowserContext_pages, "f").values()) {
            await (page === null || page === void 0 ? void 0 : page.close().catch(error => {
