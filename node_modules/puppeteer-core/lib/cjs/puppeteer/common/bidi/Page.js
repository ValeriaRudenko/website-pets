...
var _Page_instances, _Page_timeoutSettings, _Page_connection, _Page_frameTree, _Page_networkManager, _Page_viewport, _Page_closed, _Page_subscribedEvents, _Page_networkManagerEvents, _Page_onFrameAttached, _Page_onFrameNavigated, _Page_onFrameDetached, _Page_removeFramesRecursively, _Page_onLogEntryAdded;
...
class Page extends Page_js_1.Page {
    constructor(connection, info) {
        ...
        __classPrivateFieldSet(this, _Page_networkManager, new NetworkManager_js_2.NetworkManager(connection, this), "f");
    ...
    frame(frameId) {
        return __classPrivateFieldGet(this, _Page_frameTree, "f").getById(frameId !== null && frameId !== void 0 ? frameId : '') || null;
    }
    childFrames(frameId) {
    ...
    async close() {
        if (__classPrivateFieldGet(this, _Page_closed, "f")) {
            return;
        }
...
exports.Page = Page;
_Page_timeoutSettings = new WeakMap(), _Page_connection = new WeakMap(), _Page_frameTree = new WeakMap(), _Page_networkManager = new WeakMap(), _Page_viewport = new WeakMap(), _Page_closed = new WeakMap(), _Page_subscribedEvents = new WeakMap(), _Page_networkManagerEvents = new WeakMap(), _Page_instances = new WeakSet(), _Page_onFrameAttached = function _Page_onFrameAttached(info) {
    var _a;
    if (!this.frame(info.context) &&
        (this.frame((_a = info.parent) !== null && _a !== void 0 ? _a : '') || !__classPrivateFieldGet(this, _Page_frameTree, "f").getMainFrame())) {
        ...
        const frame = new Frame_js_1.Frame(this, context, info.parent);
    ...
    if (isConsoleLogEntry(event)) {
        const args = event.args.map(arg => {
            return (0, BrowsingContext_js_1.getBidiHandle)(this.mainFrame().context(), arg);
        });
        const text = args
            .reduce((value, arg) => {
