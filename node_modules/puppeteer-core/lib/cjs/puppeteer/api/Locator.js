...
class Locator extends EventEmitter_js_1.EventEmitter {
    ...
    async click(clickOptions) {
        return await __classPrivateFieldGet(this, _Locator_instances, "m", _Locator_run).call(this, async (element) => {
    ...
    async fill(value, fillOptions) {
        return await __classPrivateFieldGet(this, _Locator_instances, "m", _Locator_run).call(this, async (element) => {
            ...
            signal: fillOptions === null || fillOptions === void 0 ? void 0 : fillOptions.signal,
            conditions: [
                __classPrivateFieldGet(this, _Locator_ensureElementIsInTheViewport, "f"),
                __classPrivateFieldGet(this, _Locator_waitForVisibility, "f"),
                __classPrivateFieldGet(this, _Locator_waitForEnabled, "f"),
    ...
    async hover(hoverOptions) {
        return await __classPrivateFieldGet(this, _Locator_instances, "m", _Locator_run).call(this, async (element) => {
            ...
            signal: hoverOptions === null || hoverOptions === void 0 ? void 0 : hoverOptions.signal,
            conditions: [
                __classPrivateFieldGet(this, _Locator_ensureElementIsInTheViewport, "f"),
                __classPrivateFieldGet(this, _Locator_waitForVisibility, "f"),
                __classPrivateFieldGet(this, _Locator_waitForStableBoundingBox, "f"),
    ...
    async scroll(scrollOptions) {
        return await __classPrivateFieldGet(this, _Locator_instances, "m", _Locator_run).call(this, async (element) => {
            ...
            }, scrollOptions === null || scrollOptions === void 0 ? void 0 : scrollOptions.scrollTop, scrollOptions === null || scrollOptions === void 0 ? void 0 : scrollOptions.scrollLeft);
        }, {
            signal: scrollOptions === null || scrollOptions === void 0 ? void 0 : scrollOptions.signal,
            conditions: [
                __classPrivateFieldGet(this, _Locator_ensureElementIsInTheViewport, "f"),
                __classPrivateFieldGet(this, _Locator_waitForVisibility, "f"),
                __classPrivateFieldGet(this, _Locator_waitForStableBoundingBox, "f"),
